...
brand111=random.choice(brand11)
model122=random.choice(model11)
...
pakistani_sim_operators = ["Telekom HU","TELKOMSEL","Jazz","Telenor","Zong","Ufone","Warid Telecom","SCO","PTCL","Zong","Grammenphone","UFONE-PAKTel","Banglalink","Vodafone","Cerillion"]
def generate_FBAN():
